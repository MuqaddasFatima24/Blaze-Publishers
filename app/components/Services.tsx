...
export default function Services() {
  return (
    <section className="relative w-full bg-gradient-to-b from-white via-gray-50 to-white py-20 px-6 md:px-12 lg:px-20 overflow-hidden">
      {/* glowing bg accents */}
      ...
      <div className="relative grid sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto z-10">
        {services.map((service, index) => (
          <div
            key={index}
            className="group relative p-8 rounded-3xl bg-white/70 backdrop-blur-xl border border-orange-100 shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02] cursor-pointer"
          >
            {/* Glow behind card */}
