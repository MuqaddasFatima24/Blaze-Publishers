...
export default function Detail() {
  return (
    <>
      ...
      <Head>
        <title>Next-Level Digital Publishing | Blaze Publisher</title>
        <meta
          name="description"
          content="Discover how Blaze Publisher helps creators and businesses publish, manage, and showcase ideas with elegant, high-tech digital tools."
        />
        <meta
          name="keywords"
          content="digital publishing, content management, creators tools, Blaze Publisher, elegant design, premium publishing platform"
        />
        <meta property="og:title" content="Next-Level Digital Publishing | Blaze Publisher" />
        <meta
          property="og:description"
          content="Empower your creativity with refined digital tools for modern publishing."
        />
      ...
      <section
        id="blaze-detail"
        className="relative w-full bg-gradient-to-br from-white via-gray-50 to-white py-20 px-6 md:px-12 lg:px-20 overflow-hidden"
      >
        ...
        <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center z-10">
          {/* ── Text content ── */}
          <article className="space-y-8 animate-fadeInLeft">
            ...
            <p className="text-lg text-black leading-relaxed max-w-lg">
              ...
              <span className="font-semibold text-gray-800">refined digital tools</span> to
              publish, manage, and showcase their ideas in a truly premium way. Built with{" "}
              <span className="italic text-orange-500">simplicity</span> and
              <span className="italic text-gray-800"> precision</span>, it blends timeless
              elegance with high-tech power to redefine digital publishing.
            </p>

            <Link
              href="/learnmore"
              aria-label="Learn more about Blaze Publisher"
          ...
          <div className="relative flex justify-center md:justify-end animate-fadeInRight">
            <Image
              src="/book.png"
              alt="Elegant open book representing Blaze Publisher platform"
              width={450}
              height={450}
              priority
