...
export default function Books() {
  return (
    <section className="relative w-full py-28 px-6 md:px-12 lg:px-20 bg-white">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-lg text-black leading-relaxed">
            ...
            Whether you’re searching for <span className="text-black font-semibold">knowledge</span>, 
            <span className="text-black font-semibold"> inspiration</span>, or 
            <span className="text-black font-semibold"> pure imagination</span>, 
            our collection has something waiting for you.
          </p>
          <p className="text-lg text-black leading-relaxed font-medium">
            Explore stories that matter, written by authors who <span className="text-orange-500 font-semibold">dare to dream.</span>
          </p>
        ...
        >
          <Image
            ...
            alt="Book"
            width={500}
            height={600} // taller image for premium look
